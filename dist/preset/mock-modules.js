...
jest
  ...
  .doMock('react-native/Libraries/Renderer/shims/ReactNative', function() {
    ...
    (0,
    _extends2.default)(ReactNative.NativeComponent.prototype, _mockNativeMethods.mockNativeMethods);
    return ReactNative;
  });
